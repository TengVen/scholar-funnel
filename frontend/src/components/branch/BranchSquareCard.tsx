  ...
  return (
    <div className="card px-4 py-3.5 flex flex-col min-h-[150px]">
      ...
      {paper.method_summary && (
        <p className="mt-2 text-sm text-ink-secondary leading-relaxed line-clamp-3 flex-1">
          {paper.method_summary}
        </p>
      )}
        ...
        (paper.probe_relation || application || paper.key_findings) && (
          <div className="mt-1.5 space-y-0.5">
            {paper.probe_relation && (
              <p className="text-xs text-ink-muted line-clamp-2 flex items-start gap-1.5">
                <span
                  className="w-3.5 h-3.5 rounded shrink-0 mt-px flex items-center justify-center text-2xs"
